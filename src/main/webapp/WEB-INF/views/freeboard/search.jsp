						...
						<td colspan="4">
							<form action="/freeboard/search" method="get">
								<select name="searchCondition">
									...
									<option value="free" <c:if test="${search.searchCondition == 'free' }">selected</c:if>>잡담</option>
									<option value="question" <c:if test="${search.searchCondition == 'question' }">selected</c:if>>질문</option>
								</select>
